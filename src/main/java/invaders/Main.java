...
import spaceinvaders.actors.Actor;
import spaceinvaders.actors.Invader;
import spaceinvaders.actors.Player;
import spaceinvaders.actors.Shot;
import spaceinvaders.actors.Ufo;

public class Main extends Stage implements KeyListener {
